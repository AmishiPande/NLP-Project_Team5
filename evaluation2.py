...
class Evaluation():
    ...
    def meanPrecision(self, doc_IDs_ordered, query_ids, qrels, k):
        ...
        # Create a mapping from query_id to relevant documents
    ...
    def meanFscore(self, doc_IDs_ordered, query_ids, qrels, k):
        ...
        # Calculate F-score for each query
        total_fscore = 0.0
        num_queries = 0
    ...
    def queryNDCG(self, query_doc_IDs_ordered, query_id, true_doc_IDs, k):
        ...
        # For binary relevance, the ideal ranking would have all relevant documents first
